...
# Se o usuario n estiver logado ele vai ser redirecionado
...
def pacientes(request):
   ...
   # nome = Pacientes.objects.filter(nome=nome)
    
    #if nome.exists():
    #    messages.add_message(request, constants.ERROR, 'Já existe um paciente com esse nome')
    #    return redirect('/pacientes/')
...
# regra plano alimentar (Botão na plataforma)
...
# Bloqueiar usuarios de outros nutricionistas.
...
#Recebe tudo sobre o cadastro da refeição do paciente
...
#Recebe tudo sobre o cadastro da opcões do paciente
